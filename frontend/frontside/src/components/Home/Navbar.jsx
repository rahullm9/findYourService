...
const Navbar = () => {
    return (
      <header className="bg-white shadow-md py-1.5 px-6 md:px-12 flex flex-col sm:flex-row items-center justify-between rounded-b-lg">
        ...
        <nav className="mt-4 sm:mt-0 flex flex-row justify-center items-center" >
          <ul className="flex space-x-6">
            ...
            <li>
              <Link to="contactus" className="text-gray-700 hover:text-blue-600 font-semibold text-lg transition duration-200">Contact</Link>
            </li>
          </ul>
          <Link to="/signin" >
